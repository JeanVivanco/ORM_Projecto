...
class Libro(models.Model):
    ...
    autor = models.ForeignKey(
        Autor, on_delete=models.SET_NULL, null=True, related_name="libros"
    )
    ...
    genero = models.ManyToManyField(
        Genero, help_text="Seleccione un género para este libro"
    )
...
class EjemplarLibro(models.Model):
    ...
    libro = models.ForeignKey(
        Libro, on_delete=models.RESTRICT, related_name="ejemplares"
    )
