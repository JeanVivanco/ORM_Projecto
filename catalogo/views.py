...
def index(request):
    ...
    '''
    titulo                  resumen
    Las aventuras de jean   resumen todo pendejo

    filter(titulo__icontains="jean").conut()
    '''
    context = {
    ...
    return render(request, "home.jinja", context=context)
